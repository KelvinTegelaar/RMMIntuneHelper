...
@{
    ...
    RootModule        = '.\RMMIntuneHelper.psm1'
    ...
    GUID              = '1aaa4873-410e-4a99-9ccf-ae9600a80aee'
    ...
    FunctionsToExport = @(
        ...
        "New-NinjaRMMApplication",
        "New-SyncroRMMApplication",
        "New-DattoRMMApplication",
        "New-VSAApplication"
    )
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags         = @('Autotask', 'api', 'REST', 'RMM', 'DattoRMM', 'CyberDrain')
    
            # A URL to the license for this module.
            LicenseUri   = 'https://github.com/KelvinTegelaar/RMMIntuneHelper/blob/master/LICENSE'
    
            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/KelvinTegelaar/RMMIntuneHelper'
    ...
    HelpInfoURI       = 'https://github.com/KelvinTegelaar/RMMIntuneHelper'
